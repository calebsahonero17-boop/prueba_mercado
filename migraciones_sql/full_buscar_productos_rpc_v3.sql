...
RETURNS TABLE (
    id UUID,
    nombre CHARACTER VARYING, -- Corregido: coincide con productos.nombre
    descripcion TEXT,
    precio NUMERIC,
    stock INTEGER,
    url_imagen TEXT,
    ...
    condicion TEXT,
    destacado BOOLEAN,
    estado CHARACTER VARYING, -- Añadido: coincide con productos.estado
    categoria UUID,
...
BEGIN
    ...
    query_str := '
        SELECT
            ...
            p.condicion,
            p.destacado,
            p.estado, -- Añadido: coincide con productos.estado
            p.categoria,
