...
-- y asignarle un plan de suscripción directamente en tu base de datos Supabase.
--
...
--    - '[PLAN_DE_SUSCRIPCION]' con el plan deseado (ej: 'Vendedor Premium' o 'Vendedor Basico')
...
SET 
    rol = 'vendedor',
    plan_suscripcion = '[PLAN_DE_SUSCRIPCION]', 
